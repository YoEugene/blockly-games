...
def main(name, lang):
  ...
  f = open('appengine/%s/public/generated/%s/msg.js' % (name, lang), 'w')
  f.write(WARNING)
...
def write_uncompressed(name, lang):
  ...
  f = open('appengine/%s/public/generated/%s/uncompressed.js' % (name, lang), 'w')
  f.write("""%s
(function() {
  var srcs = [
      %s
...
def write_compressed(name, lang):
  ...
  f = open('appengine/%s/public/generated/%s/compressed.js' % (name, lang), 'w')
  f.write(WARNING)
  f.write(script)
  f.close()
